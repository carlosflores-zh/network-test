...
func setFdLimit(cur, max uint64) error {
	...
	log.Printf("Original file descriptor limit for cur=%d; max=%d.", rLimit.Cur, rLimit.Max)
	...
	log.Printf("Modified file descriptor limit for cur=%d; max=%d.", rLimit.Cur, rLimit.Max)
